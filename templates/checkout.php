<?php $title = _("Retirer du stock - laclef.cc"); ?>

<?php ob_start() ?>
<h3 class="ink-form top-space"><?php echo _("Retirer du stock"); ?></h3>
<div class="box">
	<form id="checkinForm" class="ink-form" method="post" action="stocks" onsubmit="return Ink.UI.FormValidator.validate(this);">
		<fieldset>
			...
			<div class="control-group">
				<p class="label"><?php echo _('Objet à retirer : '); ?></p>
			...
			<div class="control-group">
				<p class="label"><?php echo _('Client : '); ?></p>
				<select name="customer" class="control unstyled">
		...
		<div>
			<input type="submit" name="sub" value="<?php echo _("Retirer au stock"); ?>" class="ink-button success red" />
		</div>
	</form>
