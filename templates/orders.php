			...
			<tbody>
			  <?php foreach ($orders as $order): ?>
			    <tr>
			      ...
			      <td><span class="tooltip" data-tip-text="<?php echo $order['reader']; ?>" data-tip-where="up" data-tip-color="black"><?php if($order['reader'] == 0) echo _('Interface web'); else echo $swipe['location']; ?></span></td>
