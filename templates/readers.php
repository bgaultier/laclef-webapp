		        ...
		        <?php foreach ($swipes as $swipe): ?>
		          <tr<?php
		            ...
		            <td class="small"><?php echo datetime_to_string($swipe['timestamp']); ?></td>
					      <td><span class="tooltip" data-tip-text="<?php echo $swipe['location']; ?>" data-tip-where="up" data-tip-color="black"><?php if($swipe['reader'] == 0) echo _('Interface web'); else echo $swipe['reader']; ?></span></td>
